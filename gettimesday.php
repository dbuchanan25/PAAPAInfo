 ...
 */
   ...
   //WEBSITE CONNECTION
    ...
    $dayassignment1_usualbeginningtimeperiods=mysql_query
                    ("SELECT time, timeperiod
                      FROM timeperiods
                      WHERE timeperiod>=$sqlf[0]
                      AND timeperiod<$sqlf[1]");

    $dayassignment1_usualendingtimeperiods=mysql_query
                    ("SELECT time, timeperiod
                      FROM timeperiods
                      WHERE timeperiod>$sqlf[0]
                      AND timeperiod<=$sqlf[1]");
    ...
    while($row2 = @mysql_fetch_row($dayassignment1_usualbeginningtimeperiods))
    {
    ...
    while($row3 = @mysql_fetch_row($dayassignment1_usualendingtimeperiods))
    {
